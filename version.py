...
CHANGELOG = [
    ...
    },
    {
        "version": "1.9.59",
        "fecha":   "2026-06-29",
        "titulo":  "Inicio: visualizaciones por día sin suavizado (dato crudo)",
        "cambios": [
            "Se quitó el promedio móvil del gráfico de visualizaciones por día del inicio: vuelve al dato crudo para que se vea la evolución real día a día. Se mantiene el encuadre acotado (~3 décadas) para que los outliers bajos no estiren el eje.",
        ],
    },
    {
        "version": "1.9.58",
    ...
    },
    {
        "version": "1.9.49",
        "fecha":   "2026-06-29",
        "titulo":  "Switch de plataforma moderno y visible en cada portal",
        "cambios": [
            "El selector Instagram/Facebook de cada portal pasa a un control segmentado (pill) más grande, centrado y moderno, debajo de los KPIs principales del portal.",
        ],
    },
    {
        "version": "1.9.48",
    ...
    },
    {
        "version": "1.9.46",
        "fecha":   "2026-06-29",
        "titulo":  "Grilla resumen bajo el hero de cada portal (FB + IG)",
        "cambios": [
            "Cada portal muestra, debajo de su hero, los mismos KPIs que acompañan el hero del Panel General: Alcance, Crecimiento (seguidores netos ~30d), Engagement e Seguidores, ahora combinando Facebook + Instagram.",
        ],
    },
    {
        "version": "1.9.45",
    ...
    },
    {
        "version": "1.9.43",
        "fecha":   "2026-06-28",
        "titulo":  "Audiencia: KPIs de crecimiento (nuevos seguidores y tasa mensual)",
        "cambios": [
            "La sección de Audiencia suma dos KPIs: nuevos seguidores netos del mes (FB + IG, en verde/rojo) y crecimiento mensual (nuevos ÷ base de seguidores).",
            "Descripciones de la sección acortadas, sin aclaraciones: solo explican qué se ve.",
        ],
    },
    {
        "version": "1.9.42",
    ...
    },
    {
        "version": "1.9.40",
        "fecha":   "2026-06-28",
        "titulo":  "Nuevo KPI: Interacciones totales de la red (IG + FB)",
        "cambios": [
            "Estadísticas Globales suma un KPI de Interacciones (reacciones + comentarios + envíos, ambas plataformas, del último mes), que faltaba como número titular desde que Facebook pasó a mostrar reproducciones en vez de engagement.",
        ],
    },
    {
        "version": "1.9.39",
        "fecha":   "2026-06-28",
        "titulo":  "Tablas con estilo isla-oscura unificado + explicación de KPIs al día",
        "cambios": [
            "Las tablas de Audiencia (seguidores) y de Rendimiento de reels en Globales, y la de 'Ver todas las publicaciones' en los portales, pasaron de st.dataframe (encabezados grises) a tablas HTML con fondo oscuro propio y texto claro, legibles en tema claro y oscuro como el resto.",
            "Actualizada la explicación de los KPIs: refleja que el indicador de Facebook ahora son las reproducciones de video (no el engagement) y menciona la sección de interacciones de la red.",
        ],
    },
    {
        "version": "1.9.38",
    ...
    },
    {
        "version": "1.9.34",
        "fecha":   "2026-06-28",
        "titulo":  "Inicio: desglose Instagram vs Facebook bajo el total de visualizaciones",
        "cambios": [
            "El hero del inicio muestra, debajo del total de visualizaciones, cuánto aporta cada plataforma: '📸 X de Instagram · 📘 Y de Facebook'. Así se ve el peso real de las reproducciones de video de Facebook en el total.",
        ],
    },
    {
        "version": "1.9.33",
