...
.bloque-imp .sub { color: #c4b5fd; font-size: 13px; }
.pendiente-box {
...
if portal is None or not credenciales_ok(portal):
    ...
    st.markdown("### 📋 Qué completar en los secrets")
    st.code("""META_PAGE_ID_VISTE=ID_DE_LA_PAGINA_DE_FACEBOOK
META_INSTAGRAM_ID_VISTE=ID_NUMÉRICO_DE_INSTAGRAM
...
with tab_ig:
    ...
    st.markdown(f"""
    <div class="bloque-imp" style="background:linear-gradient(135deg,#7c3aed,#a855f7)">
